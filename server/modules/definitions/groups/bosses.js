    ...
    [
      {
        ...
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([
            g.swarm,
            g.battleship,
            { speed: 0.95, maxSpeed: 0.95, health: 1.1, resist: 1.05 },
          ]),
          TYPE: "autoswarm",
  ...
  GUNS: [
    ...
    },
    {
      ...
      PROPERTIES: {
        SHOOT_SETTINGS: combineStats([
          g.drone,
          { reload: 2, size: 0.5, speed: 0.6, maxSpeed: 0.6, heath: 1.35 },
        ]),
    ...
    [
      ...
      },
      {
        ...
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([
            g.trap,
            { speed: 1.1, maxSpeed: 1.1, reload: 1.5, damage: 1.6 },
          ]),
          TYPE: "trap",
          STAT_CALCULATOR: "trap",
        },
      ...
      [
        {
          ...
          TYPE: [
            "autoTurret",
            { INDEPENDENT: false, GUN_STAT_SCALE: { health: 1.1 } },
          ],
        },
        {
          POSITION: [5, 8, 7, 60, 160, 0],
...
Class.destroyerLegion = {
  ...
  TURRETS: [
    ...
    ),
    {
      ...
      TYPE: [
        "bigauto4gun",
        { GUN_STAT_SCALE: { health: 1.1 }, INDEPENDENT: true, COLOR: -1 },
      ],
    },
  ],
};
    ...
    },
    {
      ...
      PROPERTIES: {
        SHOOT_SETTINGS: combineStats([
          ...
          g.setTrap,
          g.pounder,
          { health: 1.1, speed: 1.5, range: 0.3 },
        ]),
        TYPE: "unsetPillbox",
        STAT_CALCULATOR: "trap",
      },
    ...
    [
      {
        ...
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([
            g.swarm,
            g.battleship,
            { speed: 1.05, maxSpeed: 1.05, health: 1.2, resist: 1.1 },
          ]),
          TYPE: "autoswarm",
          STAT_CALCULATOR: "swarm",
        },
  ...
  GUNS: [
    ...
    },
    {
      ...
      PROPERTIES: {
        SHOOT_SETTINGS: combineStats([
          g.drone,
          { reload: 2, size: 0.5, speed: 0.65, maxSpeed: 0.65, heath: 1.5 },
        ]),
        TYPE: "sentrySwarmMinion",
        SYNCS_SKILLS: true,
        AUTOFIRE: true,
  ...
  TURRETS: [
    {
      ...
      TYPE: [
        "auto4gun",
        { GUN_STAT_SCALE: { health: 1.15 }, INDEPENDENT: false, COLOR: -1 },
      ],
    },
  ],
};
    ...
    [
      {
        ...
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([
            g.swarm,
            g.pounder,
            { speed: 2, maxSpeed: 1.7, size: 0.6, range: 2.8 },
          ]),
        ...
        },
        {
          ...
          PROPERTIES: {
            SHOOT_SETTINGS: combineStats([
              ...
              g.setTrap,
              g.pounder,
              { reload: 2, speed: 2, size: 0.65, maxSpeed: 2, range: 0.65 },
            ]),
  ...
  GUNS: weaponArray(
    {
      ...
      PROPERTIES: {
        SHOOT_SETTINGS: combineStats([
          ...
          g.machineGun,
          g.machineGunner,
          { damage: 1.8, size: 0.4, spray: 150, speed: 2, shudder: 1.75 },
        ]),
        TYPE: "minichip",
        AUTOFIRE: true,
        SYNCS_SKILLS: true,
  ...
  GUNS: weaponArray(
    {
      ...
      PROPERTIES: {
        SHOOT_SETTINGS: combineStats([
          ...
          g.summoner,
          g.destroyer,
          { size: 1.1, maxSpeed: 1.2, damage: 1.1 },
        ]),
        TYPE: "realchip",
        AUTOFIRE: true,
        SYNCS_SKILLS: true,
  ...
  GUNS: weaponArray(
    {
      ...
      PROPERTIES: {
        SHOOT_SETTINGS: combineStats([
          g.factory,
          g.pounder,
          { reload: 2, damage: 0.7, density: 0.6 },
        ]),
  ...
  TURRETS: weaponArray(
    {
      ...
      TYPE: [
        "baseTrapTurret",
        { GUN_STAT_SCALE: { health: 0.7, damage: 0.8 } },
      ],
    },
    6
  ),
    ...
    [
      {
        ...
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([
            ...
            g.shotgun,
            g.pounder,
            { reload: 2, damage: 1.5, health: 1.5, resist: 1.25 },
          ]),
          TYPE: "casing",
        },
      },
...
gersemi.addLayer({
  turret: {
    ...
    TYPE: [
      "swarmTurret",
      { INDEPENDENT: true, GUN_STAT_SCALE: { health: 1.7, damage: 1.2 } },
    ],
  },
});
gersemi.addLayer(
  {
    turret: {
      ...
      TYPE: [
        "basicTurret",
        { INDEPENDENT: true, GUN_STAT_SCALE: { health: 1.8, damage: 1.3 } },
      ],
    },
  },
  true,
...
ezekiel.addLayer(
  {
    turret: {
      ...
      TYPE: [
        setTurretProjectileRecoil("skimmerTurret", 0.5),
        { COLOR: "grey", INDEPENDENT: true, GUN_STAT_SCALE: { maxSpeed: 0.5 } },
      ],
    },
  },
  true,
...
eris.addLayer(
  {
    gun: {
      ...
      PROPERTIES: {
        SHOOT_SETTINGS: combineStats([
          g.factory,
          { size: 0.7, maxSpeed: 0.85, damage: 0.8 },
        ]),
...
eris.addLayer(
  {
    turret: {
      POSITION: [10, 8.5, 0, null, 160, 0],
      TYPE: [
        setTurretProjectileRecoil("rocketeerTurret", 0.43),
        { INDEPENDENT: true, GUN_STAT_SCALE: { maxSpeed: 0.43 } },
      ],
    },
  },
  true,
...
zaphkiel.addLayer(
  {
    turret: {
      POSITION: [10, 7.5, 0, null, 160, 0],
      TYPE: [
        setTurretProjectileRecoil("skimmerTurret", 0.65),
        {
          COLOR: "grey",
          INDEPENDENT: true,
          GUN_STAT_SCALE: { maxSpeed: 0.65 },
        },
      ],
    },
  },
...
nyx.addLayer(
  {
    turret: {
      POSITION: [10, 7.5, 0, null, 160, 0],
      TYPE: [
        setTurretProjectileRecoil("rocketeerTurret", 0.5),
        { INDEPENDENT: true, GUN_STAT_SCALE: { maxSpeed: 0.5 } },
      ],
    },
  },
  true,
...
atlas.addLayer(
  {
    turret: {
      ...
      TYPE: [
        "nailgunTurret",
        { GUN_STAT_SCALE: { speed: 1.1, maxSpeed: 1.1, resist: 1.3 } },
      ],
    },
  },
  true,
...
julius.addLayer(
  {
    turret: {
      POSITION: [10.5, 8, 0, null, 160, 0],
      TYPE: [
        setTurretProjectileRecoil("launcherTurret", 0.82),
        { GUN_STAT_SCALE: { health: 1.3, damage: 1.3, maxSpeed: 0.82 } },
      ],
    },
  },
  true,
...
odin.addLayer(
  {
    gun: {
      ...
      PROPERTIES: {
        ...
        TYPE: [
          "realchip",
          { INDEPENDENT: true, DRAW_HEALTH: true, COLOR: "hexagon" },
        ],
        AUTOFIRE: true,
        SYNCS_SKILLS: true,
      },
  ...
  GUNS: [
    {
      ...
      PROPERTIES: {
        SHOOT_SETTINGS: combineStats([
          ...
          g.machineGun,
          g.thruster,
          { range: 0.375, reload: 0.75, recoil: 1.05 },
        ]),
        TYPE: "bullet",
      },
    },
...
Class.AEMKShipBoss = {
  ...
  UPGRADE_TOOLTIP:
    "Has 4 carrier's, 4 factories, and their own auras. NOW FACE MY DESTRUCTION!",
  COLOR: 32,
  UPGRADE_COLOR: 32,
  GLOW: {
    RADIUS: 1.5,
